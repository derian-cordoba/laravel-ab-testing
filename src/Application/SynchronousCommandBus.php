...
final readonly class SynchronousCommandBus implements CommandBus
{
    ...
    public function dispatch(object $command): void
    {
        ...
        //   → ABTests\Application\CommandHandlers\StartExperimentCommandHandler
        //
        ...
        // it would also corrupt the already-replaced 'CommandHandlers' segment.
        $handlerClass = str_replace('\\Commands\\', '\\CommandHandlers\\', get_class($command)) . 'Handler';
