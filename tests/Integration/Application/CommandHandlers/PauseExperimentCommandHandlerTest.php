...
final class PauseExperimentCommandHandlerTest extends DatabaseTestCase
{
    ...
    public function pause_transitions_running_experiment_to_paused(): void
    {
        ...
        (new PauseExperimentCommandHandler(new DatabaseExperimentRepository(), new DatabaseAuditLogRepository(), new LaravelDomainEventDispatcher()))->handle(new PauseExperimentCommand(
