        ...
        <div class="space-y-3">
            @foreach($rows as $row)
                @php
                    ...
                    $statusEnum = \ABTests\Enums\ExperimentStatus::tryFrom($model->status);
                @endphp
                <div x-data="{ open: false }"
                    ...
                    <div x-show="open"
                        ...
                        {{-- Archived notice --}}
                        @if($statusEnum === \ABTests\Enums\ExperimentStatus::archived)
                            <div class="flex items-center gap-2.5 border-b border-gray-700/60 bg-gray-800/40 px-5 py-3">
                                <svg class="h-4 w-4 shrink-0 text-gray-500" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="m20.25 7.5-.625 10.632a2.25 2.25 0 0 1-2.247 2.118H6.622a2.25 2.25 0 0 1-2.247-2.118L3.75 7.5M10 11.25h4M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125Z"/>
                                </svg>
                                <p class="text-xs text-gray-500">
                                    This experiment is <strong class="text-gray-400">archived</strong> and read-only. No further lifecycle actions are available.
                                </p>
                            </div>
                        @endif
