...
<div>
    ...
    <div class="rounded-lg border border-gray-700 bg-gray-900 p-6 space-y-6">
        ...
        {{-- Enable / Disable --}}
        <div>
            <h3 class="text-sm font-semibold text-gray-300 mb-3">Toggle</h3>
            ...
            <div class="flex items-center justify-between gap-4">
                <p class="text-sm text-gray-400">
                    @if($model !== null && $model->killed_at !== null)
                        Kill switch is <strong class="text-red-400">active</strong>. The flag resolves to its default value for all units regardless of other settings.
                    @else
        ...
        <div class="border-t border-gray-700/60 pt-5">
            <div class="flex items-center justify-between mb-1">
                <h3 class="text-sm font-semibold text-gray-300">Targeting Conditions</h3>
